...
const ZONING_OPTIONS = [
  ...
  'GENERAL OFFICE',
  'HEAVY INDUSTRIAL',
  'HEAVY INDUSTRIAL (FLOOD)',
  'HIGH DENSITY RESIDENTIAL',
  'HIGHWAY BUSINESS',
  'HIGHWAY COMMERCAL',
  'LARGE LOT / ESTATE RESIDENTIAL',
  'LARGE LOT / ONE ACRE RESIDENTIAL',
  'LIGHT INDUSTRIAL',
  'LIGHT INDUSTRIAL (FLOOD)',
  'LIMITED OFFICE',
  ...
  'PLANNED COMMERCIAL',
  'PLANNED DEVELOPMENT',
  'PLANNED DEVELOPMENT (COMM)',
  'PLANNED DEVELOPMENT (IND)',
  'PLANNED DEVELOPMENT (MIXED USE)',
  'PLANNED INDUSTRIAL PARK',
  'PLANNED RES DEVELOPMENT',
  'PLANNED UNIT DEVELOPMENT (COMM)',
  'PUBLIC OPEN SPACE',
  'RESIDENTIAL ALT MEDIUM DENSITY',
  'RESIDENTIAL ESTATE',
  'RESIDENTIAL HIGH DENSITY',
  'RESIDENTIAL LARGE LOT',
  'RESIDENTIAL LOW DENSITY',
  'RESIDENTIAL LOWEST DENSITY',
  ...
  'SOUTH DOWNTOWN RESIDENTIAL',
  'SOUTH MAIN RESIDENTIAL',
  'SPORTS AND ENTERTAINMENT',
  'TOWNHOUSE RESIDENTIAL',
  'TWO FAMILY RESIDENTIAL',
  'UPTOWN LIGHT INDUSTRIAL',
