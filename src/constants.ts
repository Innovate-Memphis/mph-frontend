...
const ASSESSMENT_GROUP_LAYER_ID = "BROKNECJT7ymXsLhMgPYoD"
...
const LAND_USE_CATEGORY = "Land Use Category";
const LAND_USE_CATEGORY_OPTIONS = [VACANT, RESIDENTIAL, COMMERCIAL, INDUSTRIAL, INSTITUTIONAL, RECREATIONAL, EXEMPT, OTHER];

const LAND_USE_CODE = "Land Use Code"
const LUC_DESC_OPTIONS = ["ACCESSRYIMP",
  "APARTMENTCOMPLEX",
  "APARTMENTHIGHRISE",
  "APRTGARDEN",
  "AUDITORIUM",
...
const ZONING_CODE_DESCRIPTION = "Zoning Code";
const ZONING_OPTIONS = ["AGRICULTURAL",
  "AGRICULTURAL(FLOODPLAIN)",
  "AGRICULTURALANDOPENLAND",
  "AGRICULTURALRESIDENTIAL",
  "BLUFFVIEWRESIDENTIAL",
  ...
  "GENERALOFFICE",
  "HEAVYINDUSTRIAL",
  "HEAVYINDUSTRIAL(FLOOD)",
  "HIGHDENSITYRESIDENTIAL",
  "HIGHWAYBUSINESS",
  "HIGHWAYCOMMERCAL",
  "LARGELOT/ESTATERESIDENTIAL",
  "LARGELOT/ONEACRERESIDENTIAL",
  "LIGHTINDUSTRIAL",
  "LIGHTINDUSTRIAL(FLOOD)",
  "LIMITEDOFFICE",
  ...
  "MIXEDUSE",
  "MOBILEHOME",
  "MODERATEDENSITYRESIDENTIAL",
  "MULTIFAMILYRESIDENTIAL",
  "MULTIPLEDWELLINGRESIDENTIAL",
  "MULTIPLEFAMILYDWELLING",
  ...
  "PLANNEDCOMMERCIAL",
  "PLANNEDDEVELOPMENT",
  "PLANNEDDEVELOPMENT(COMM)",
  "PLANNEDDEVELOPMENT(IND)",
  "PLANNEDDEVELOPMENT(MIXEDUSE)",
  "PLANNEDINDUSTRIALPARK",
  "PLANNEDRESDEVELOPMENT",
  "PLANNEDUNITDEVELOPMENT(COMM)",
  "PUBLICOPENSPACE",
  "RESIDENTIALALTMEDIUMDENSITY",
  "RESIDENTIALESTATE",
  "RESIDENTIALHIGHDENSITY",
  "RESIDENTIALLARGELOT",
  "RESIDENTIALLOWDENSITY",
  "RESIDENTIALLOWESTDENSITY",
  "RESIDENTIALMEDIUMDENSITY",
  "RESIDENTIALMULTIFAMILY",
  "RESIDENTIALSINGLEFAMILY",
  "RESIDENTIALSINGLEFAMILY10",
  "RESIDENTIALSINGLEFAMILY15",
  "RESIDENTIALSINGLEFAMILY5",
  "RESIDENTIALSINGLEFAMILY6",
  "RESIDENTIALSINGLEFAMILY8",
  "RESIDENTIALTWOFAMILY",
  "RESIDENTIALURBAN1",
  "RESIDENTIALURBAN2",
  "RESIDENTIALURBAN3",
  "RESIDENTIALURBAN4",
  "RESIDENTIALURBAN5",
  "RESIDENTIALWORK",
  "RESTRICTEDINDUSTRIAL",
  "RESTRICTIVEINDUSTRIAL",
  "RIVERSIDERESIDENTIAL",
  "SHOPPINGCENTERCOMMERCIAL",
  "SINGLEFAMILYRESIDENTIAL",
  "SOUTHDOWNTOWNBUSINESSPARK",
  "SOUTHDOWNTOWNRESIDENTIAL",
  "SOUTHMAINRESIDENTIAL",
  "SPORTSANDENTERTAINMENT",
  "TOWNHOUSERESIDENTIAL",
  "TWOFAMILYRESIDENTIAL",
  "UPTOWN",
...
export const LAND_USE_ZONING_FILTER_MAP = new Map<string | null, Array<string | number>>([
  [LAND_USE_CATEGORY, LAND_USE_CATEGORY_OPTIONS],
  [LAND_USE_CODE, LUC_DESC_OPTIONS],
  [ZONING_CODE_DESCRIPTION, ZONING_OPTIONS]
]);

const LAND_USE_CATEGORY_FILTER: Filters = ["land_use_category", "in", []];
const LUC_DESC_FILTER: Filters = ["prop_lucdesc", "in", []];
const ZONING_FILTER: Filters = ["zon_code_desc", "in", []];

export const LUC_ZONING_FELT_FILTER_MAP = new Map<string | null, Filters>([
  [LAND_USE_CATEGORY, LAND_USE_CATEGORY_FILTER],
  [LAND_USE_CODE, LUC_DESC_FILTER],
  [ZONING_CODE_DESCRIPTION, ZONING_FILTER]
]);
